...
- `ULTRA_WSDL_USERNAME` / `ULTRA_WSDL_PASSWORD` – credențiale pentru autentificarea SOAP basic la endpoint (clientul folosește `SOAP_AUTHENTICATION_BASIC` + antet HTTP Authorization pentru preluarea WSDL-ului).
...
> Necesită extensia PHP `ext-soap` activată pentru a putea comunica cu serviciul Ultra.
